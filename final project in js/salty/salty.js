...
//loader
// async fun get data
async function getUserAsyncSalty() {
  let response = await fetch(
    `https://api.edamam.com/api/recipes/v2?type=public&q=Italian&app_id=c200b080&app_key=d4e33ef484921f29fcc246e7fa60e28f`,
  );
  let data = await response.json();

  data = data.hits;
  function dataSalty(newData) {
